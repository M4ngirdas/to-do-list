    ...
    return (
        <>
            ...
            <dialog
                ...
                className={`${props.settingsOpen ? "grid" : "hidden"} w-full sm:max-w-xl 2xl:max-w-2xl gap-4 text-lg rounded-md p-4 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-yellow-50 bg-slate-900`}>
